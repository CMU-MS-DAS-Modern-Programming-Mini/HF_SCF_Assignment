...
def test_solve_Roothan_equations(mol_h2o):
    ...
    assert mo_e == pytest.approx([-32.57830292,  -8.08153571,  -7.55008599,
                                  ...
                                  -3.98111115]) \
        and mo_c[0, :] == pytest.approx([-1.00154358e+00,  2.33624458e-01,
                                        4.97111543e-16, -8.56842145e-02,
                                        2.02299681e-29,  -4.82226067e-02,
                                        -4.99600361e-16]), \
        "Solve Roothan Equations Test (H2O) Failed"
    # assert mo_c[0,0] == pytest.approx(-1.00154358e+00), "0"
    # assert mo_c[0,1] == pytest.approx(-2.33624458e-01), "1" #fails
    # assert mo_c[0,2] == pytest.approx(4.97111543e-16), "2"
    # assert mo_c[0,3] == pytest.approx(-8.56842145e-02), "3"
    # assert mo_c[0,4] == pytest.approx(2.02299681e-29), "4"
    # assert mo_c[0,5] == pytest.approx(4.82226067e-02), "5" #fails
    # assert mo_c[0,6] == pytest.approx(-4.99600361e-16), "6"
